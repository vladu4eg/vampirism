LUMBER_STACK_T1 = 50
LUMBER_STACK_T2 = 800
LUMBER_STACK_T3 = 2400
LUMBER_STACK_T4 = 9600
LUMBER_STACK_T5 = 38400
...
function FindClosestResourceDeposit( caster )
	...
	for _,building in pairs(buildings) do
		if string.match(building:GetUnitName(),"house") then
